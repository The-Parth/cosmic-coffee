...
function navbar_modification() {
    ...
    if (scrollp >= 110) {
        if (width > 768) {
            ...
            let elem = document.getElementById("navbarSupportedContent");
            elem.style.background = "rgba(255, 200, 140,1)";
        }
        document.getElementsByClassName("navbar")[0].style.background = "rgba(255, 200, 140,1)";
        ...
        document.getElementsByClassName("navbar")[0].style.background = "rgba(255, 200, 140," + op + ")";
        ...
        if (width > 768) {
            ...
            let elem = document.getElementById("navbarSupportedContent");
            elem.style.background = "rgba(255, 200, 140," + op + ")";
        }
    }
    else {
